package com.example.lab1savkops;
import com.example.lab1savkops.R;
...
import com.example.lab1savkops.model.Image;
import com.example.lab1savkops.model.ImageApi;
import com.example.lab1savkops.model.ImageResponse;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authorBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showAlertDialog("Автор", "Разработал Савко Павел, группа АС-63");
            }
        });
